    ...
    {hasConversation && (
      ...
      >
        ...
        <section className="mx-auto max-w-3xl pb-10 pt-14 text-center">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl border border-cyan-400/25 bg-cyan-400/10 text-cyan-300 shadow-[0_0_40px_rgba(34,211,238,0.12)]">
            <LifeBuoy
              size={30}
              aria-hidden="true"
            />
