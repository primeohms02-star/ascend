...
export default function CompleteMissionButton({
  ...
  async function completeMission() {
    ...
    try {
      ...
      // Refresh the dashboard data in place. This keeps the user at the
      // mission card while the completed mission, XP, and next mission update.
      router.refresh();
    } catch (error) {
      setError(
  ...
  return (
    <div>
      ...
      >
        {loading ? "Completing Mission..." : "Complete Mission"}
      </button>
