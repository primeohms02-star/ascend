export default function CompassGlass() {
  return (
    ...
    >
      ...
      <div className="absolute left-[10%] top-[22%] h-[43%] w-[17%] rotate-[9deg] rounded-full bg-gradient-to-r from-white/[0.08] to-transparent blur-lg" />

      <div className="absolute right-[7%] top-[25%] h-[38%] w-[10%] rounded-full bg-cyan-300/[0.045] blur-lg" />

      <div className="ascend-compass-light-sweep absolute bottom-[-15%] left-[-40%] top-[-15%] w-[22%] rotate-[18deg] bg-gradient-to-r from-transparent via-white/[0.09] to-transparent blur-sm" />
      ...
      <div className="absolute bottom-[7%] left-1/2 h-[5%] w-[48%] -translate-x-1/2 rounded-full bg-[radial-gradient(ellipse,rgba(96,165,250,0.07)_0%,transparent_72%)]" />
