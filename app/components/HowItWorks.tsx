...
const steps = [
  ...
  },
  {
    ...
    icon: SearchCheck,
    label: "Decision",
    title: "Explore possibilities beyond ASCEND",
    description:
      "Explore external possibilities and use the Atlas Decision Engine to decide what deserves your time and attention.",
  },
  {
    number: "05",
    icon: TrendingUp,
